...
# Standalone torch/stdlib helpers, extracted so both vae.py and inn.py share
# one copy. These replace what the original private lab package obtained from
# its shared model-utilities module.
